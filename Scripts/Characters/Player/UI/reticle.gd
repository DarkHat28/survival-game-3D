...
func adjust_reticle_lines():
	...
	reticle_lines[0].position = lerp(reticle_lines[0].position, pos + Vector2(-speed * reticle_distance, 0.0), reticle_distance) #Left
	reticle_lines[1].position = lerp(reticle_lines[1].position, pos + Vector2(speed * reticle_distance, 0.0), reticle_distance) #Right
	reticle_lines[2].position = lerp(reticle_lines[2].position, pos + Vector2(0.0, -speed * reticle_distance), reticle_distance) #Top
	reticle_lines[3].position = lerp(reticle_lines[3].position, Vector2(0.0, speed * reticle_distance), reticle_distance) #Bottom
